...
static void InitializeSystem(void)
{
        ...
        #endif
        //Configure all I/O pins for digital mode
        ANSELA = 0x01;
        ANSELB = 0x00;
        ANSELC = 0x00;
        ANSELD = 0x00;
...
/********************************************************************
 * Function:        void SensorReport(void)
 *******************************************************************/
void SensorReport(void)
{
    int i;
    ...
    if(!HIDTxHandleBusy(USBInHandle)) {
    	USBInHandle = HIDTxPacket(HID_EP,(BYTE*)&packet,10);
    }
}
    ...
    {   
        ...
        switch(ReceivedDataBuffer[0])				//Look at the data the host sent, to see what kind of application specific command it sent.
        {
            ...
            case 0x81:  //Get push button state
                ...
                break;
            case 0x82:  //Toggle On/Off
                break;
            case 0x83: // read version info
                if(!HIDTxHandleBusy(USBInHandle))
                {
	 	    ToSendDataBuffer[0] = 0x83;  	//Echo back to the host the command we are fulfilling in the first byte.  In this case, the Read POT (analog voltage) command.
